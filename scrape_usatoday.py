...
url = "http://sportsdata.usatoday.com/football/nfl/odds"

#   https://sportsdata.usatoday.com/football/nfl/scores?season=2024&type=Week%201 (week 1)
#    https://sportsdata.usatoday.com/football/nfl/scores?season=2024&type=Week%2018 (week 18)
...
with open(settings.data_path + 'usatoday.json', 'w') as f:
    f.write(df.to_json(orient='index'))

with open(settings.data_path + "usatoday.json") as stats_json:
    dict_stats = json.load(stats_json, object_pairs_hook=OrderedDict)
stats_sheet = open(settings.data_path + 'usatoday.csv', 'w', newline='')
